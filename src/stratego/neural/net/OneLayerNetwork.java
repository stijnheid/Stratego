...
/**
 * Allows creation of a one layer neural network, where the user can specify
...
public class OneLayerNetwork {
   ...
   static String testEvaluation;
    ...
    OneLayerNetwork(int num_input, int num_hidden, int num_output, int iteration, int score_listener, String network_name){
