...
/**
 * Allows creation of a two layer neural network, where the user can specify
...
public class TwoLayerNetwork {
   ...
   static String testEvaluation;
    ...
    TwoLayerNetwork(int num_input, int num_hidden, int num_output, int iteration, int score_listener, String network_name){
    ...
    TwoLayerNetwork(int num_input, int num_hidden_first, int num_hidden_second, int num_output, int iteration, int score_listener, String network_name){
    ...
    */
    public void storeNetwork(String name) throws IOException{
        ...
        String pathname = "src/NetworkFiles/"+name+".zip";
